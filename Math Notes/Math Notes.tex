...
%			\legend{$z = x + iy$}
	...
	For all $z \in \mathbb{C}\setminus\{0\}$, there is an unique additive inverse $(-z)$ and unique multiplicative inverse $(z^{-1})$ such that 
	\begin{align*}
		&z + (-z) = 0  & &zz^{-1} = 1 \\
	...
	\end{tikzpicture}
	\end{center}
	Likewise, naturally extends to the definition of a modulus of a complex number. 
