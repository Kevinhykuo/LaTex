...
%					node[midway,above right,inner sep=2pt,font={\footnotesize}]{$\theta$};
	...
	\begin{theorem}
		\label{Limit of u(z), v(z), and f(z) Theorem - Complex}
