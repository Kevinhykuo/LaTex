...
%			\legend{$z = x + iy$}
	...
	\begin{definition}[Polar Form of $z$]
		Consider $z \in \mathbb{C}$. Let $r = \abs{z}$, and $\theta$ be the angle between $z$ and the real axis in radians. 
		The angle $\theta$ is undefined at $z=0$, so for $\forall z \in \mathbb{C}, z \neq 0$:
